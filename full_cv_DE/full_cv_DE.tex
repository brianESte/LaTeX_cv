...
\employmentEntry{Hilfswissenschaftler}{Autonomous Digitization Technologies bei Fraunhofer IGD}
	...
	% {Refactored and expanded upon a codebase managing multiple serial peripheral connections to enhance program functionality and code readability}
	{Umarbeitung und Erweiterung eines Raspberry Pi Projekts, der mehrere serielle Schnittstellen verwaltet, um Programmfunktionalität und Codelesbarkeit aufzuwerten}
}
...
%Supported development of a paper for scholarly journals,
	...
	{Erstellung von Graphiken und Maßzahlen für die Hauptautorin des Papers}
}
...
\employmentEntry{Teamleiter bei einem autonomen Roboterwettbewerb}{Virginia Western Community College}{%
	...
	{Leitung einer Studentengruppe um einen Roboter zu entwickeln, der die Wettbewerbspiste navigieren konnte},
	% {Entwicklung einer Lösung zur gegebenen Aufgabe als Gruppe},
	{Erstellung von Lösungskonzepte mittels CAD um Probleme bei der Fertigung zu vermeiden},
	% {Generated solution concepts and planned the design in CAD to avoid assembly issues},
	{Programmierung und Fehlerbehebung des Roboters in der BASIC Sprache}
